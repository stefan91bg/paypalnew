...
import { supabase } from '../../lib/supabaseClient'; // ✨ UVEZENI SUPABASE CLIENT
import fs from 'fs';
...
        
        // =======================================================
        // ✨ LOGIKA ZA PROVERU I BROJANJE FREE TRIAL LIMITE (3)
        // OVO SE IZVRŠAVA SAMO AKO JE preview: false (kada se preuzima PDF)
        // =======================================================
        ...
        if (!preview) {
            ...
            // 1. Dohvatanje trenutnog brojača za dati Workspace
            ...
            if (fetchError || !installation) {
                console.error(`Installation not found in DB for workspace: ${workspaceId}.`);
            ...
            // 3. Povećanje brojača za 1 pre generisanja PDF-a
...
// ... (veliki deo koda za generisanje PDF-a)
// ...
